    ...
    return (
      <div className="container mx-auto p-8">
        ...
        <p className="text-lg leading-relaxed mb-6">
          Welcome to the Salary Negotiation Guide! Our mission is to empower job seekers with the knowledge and tools they need to effectively negotiate their salaries and achieve their career goals.
        </p>
        <p className="text-lg leading-relaxed mb-6">
